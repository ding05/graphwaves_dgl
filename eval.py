...
checkpoint = torch.load(models_path + 'checkpoint_SSTAGraphDataset_windowsize_3_leadtime_1_numsample_1677_trainsplit_0.8_numepoch_100.tar')
...
plt.savefig(out_path + 'plot_GNN_SSTAGraphDataset_windowsize_' + str(window_size) + '_leadtime_' + str(lead_time) + '_numsample_' + str(num_sample) + '_trainsplit_' + str(train_split) + '_numepoch_' + str(epoch) + '.png')
