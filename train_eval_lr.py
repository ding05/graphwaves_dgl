...
plt.xlabel('Month')
plt.ylabel('SSTA')
plt.title('LR_SSTAGraphDataset_leadtime_1_numsample_1679_trainsplit_0.8_RMSE_' + str(round(test_mse, 4)), fontsize=12)
...
plt.savefig(out_path + 'plot_LR_SSTAGraphDataset_leadtime_1_numsample_1679_trainsplit_0.8.png')
