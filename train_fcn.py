    ...
    #for model_num in range(1):
        ...
        class FCN(nn.Module):
            def __init__(self):
                ...
                #self.regularization = nn.regularization(0.25)
                self.double()
